...
| <a name="module_apim_named_values"></a> [apim\_named\_values](#module\_apim\_named\_values) | git::https://github.com/launchbynttdata/tf-azurerm-module_primitive-api_management_named_value.git | feature!/initial-implementation |
